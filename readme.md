...
- Por ahora hay un index.html que tiene un índice a los trabajos prácticos que vamos a hacer en la cursada(por el momento solo hay uno). Dentro de cada trabajo práctico hay índices también que llevan a cada ejercicio.
...
#### Estructura 
- Por el momento en el repositorio existen las carpetas de CSS con su assets donde guardo la imagen que se usa para el fondo, la carpeta vacía de JS y la carpeta del tp1 donde están subidos los 8 scripts html de los ejercicios y sus respectivos archivos 'action'. Dentro de esa carpeta también existe un script php 'funciones.php' que guarda algunas funciones que se repetían entre los scripts a modo de modularizar un poco el trabajo.
