<!-- Ejercicio 5
Ejercicio 3 – Agregue al formulario creado en el ejercicio 2 un input file que les permita adjuntar la
imagen de película que se está cargando. Cuando se envía el formulario se deberá guardar la imagen
y luego mostrarla junto con la información cargada en el formulario. OBS: Recuerde chequear los
permisos sobre el directorio donde se almacenarán los archivos.-->
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="card-body p-4">
                    <form action="portadaCine.php" method="POST" class="row g-3" onsubmit="validarAnio(); return validarImagen()" enctype="multipart/form-data">
                        <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold text-secondary">Portada</label>
                            <input class="form-control portada" type="file" name="portada" required accept=".jpg, .jpeg, .png">
                            <!-- si pongo el accept es necesario validar con js que sea ese formato? -->
                            <p class="error textoImagen"></p>
                        </div>
